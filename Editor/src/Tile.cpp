...
Tile::Tile(int _x, int _y,int _type,int _fil, int _col,int w, int h){
    mBox.x = _x;
    mBox.y = _y;    
    mBox.w = w;
    mBox.h = h;    
...
int Tile::getFacty() const{
    return fil*TILE_OPTION;
}

int Tile::getFactx() const{
    return col*TILE_OPTION;
}
